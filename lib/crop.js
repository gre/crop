...
(function (crop, doc) {
    ...
    function cursorInsideSelection(x,y) {
        var insidex_pos = selection.l >= 0.0 && x >= selection.x && x <= (selection.x + selection.l),
            insidex_neg = selection.l <= 0.0 && x <= selection.x && x >= (selection.x + selection.l),
            insidey_pos = selection.h >= 0.0 && y >= selection.y && y <= (selection.y + selection.h),
            insidey_neg = selection.h <= 0.0 && y <= selection.y && y >= (selection.y + selection.h);
